...
**Planning only — initial Milestone 0 architecture review completed; documentation corrections awaiting corrected-state review.** No framework, tests, dependencies, browser installation, or CI workflow exists. Installation and test commands are not yet implemented or validated.
